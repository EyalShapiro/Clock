...
function pushCommonFlags(flags, options, keys) {
  ...
  var drop = getFlag(options, keys, "drop", mustBeArray);
  var dropLabels = getFlag(options, keys, "dropLabels", mustBeArray);
  ...
  if (drop) {
    ...
    try {
      for (var _iterator3 = drop[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
        var what = _step3.value;
  ...
  if (dropLabels) flags.push("--drop-labels=".concat(Array.from(dropLabels).map(function (what) {
    return validateStringValue(what, "dropLabels");
  }).join(",")));
  if (mangleProps) flags.push("--mangle-props=".concat(mangleProps.source));
  if (reserveProps) flags.push("--reserve-props=".concat(reserveProps.source));
  ...
  if (pure) {
    ...
    try {
      for (var _iterator4 = pure[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
        var fn = _step4.value;
...
function flagsForBuildOptions(callName, options, isTTY2, logLevelDefault, writeDefault) {
  ...
  if (resolveExtensions) {
    ...
    try {
      for (var _iterator5 = resolveExtensions[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
  ...
  if (mainFields) {
    ...
    try {
      for (var _iterator6 = mainFields[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
        var _value2 = _step6.value;
        validateStringValue(_value2, "main field");
  ...
  if (conditions) {
    ...
    try {
      for (var _iterator7 = conditions[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
        var _value3 = _step7.value;
        validateStringValue(_value3, "condition");
  ...
  if (external) {
    ...
    try {
      for (var _iterator8 = external[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
  ...
  if (inject) {
    ...
    try {
      for (var _iterator9 = inject[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
        var path3 = _step9.value;
  ...
  if (nodePathsInput) {
    ...
    try {
      for (var _iterator10 = nodePathsInput[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
        var _value4 = _step10.value;
        _value4 += "";
        nodePaths.push(_value4);
      }
    } catch (err) {
  ...
  var handleIncomingPacket = function handleIncomingPacket(bytes) {
    if (isFirstPacket) {
      ...
      if (binaryVersion !== "0.19.8") {
        throw new Error("Cannot start service: Host version \"".concat("0.19.8", "\" does not match binary version ", quote(binaryVersion)));
      }
      ...
      var result = {
        ...
        serve: function serve() {
          ...
          return new Promise(function (resolve, reject) {
            ...
            var keys = {};
            var port = getFlag(options2, keys, "port", mustBeInteger);
...
var handlePlugins = function handlePlugins(buildKey, sendRequest, sendResponse, refs, streamIn, requestCallbacks, initialOptions, plugins, details) {
  var onStartCallbacks, onEndCallbacks, onResolveCallbacks, onLoadCallbacks, onDisposeCallbacks, nextCallbackID, i, requestPlugins, isSetupDone, _iteratorNormalCompletion11, _didIteratorError11, _iteratorError11, _loop3, _iterator11, _step11, _ret, runOnEndCallbacks, scheduleOnDisposeCallbacks;
    ...
    while (1) {
      switch (_context9.prev = _context9.next) {
        case 0:
          ...
          _iterator11 = plugins[Symbol.iterator]();
        ...
        case 39:
          ...
          requestCallbacks["on-resolve"] = function _callee3(id, request) {
            var response, name, callback, note, _iteratorNormalCompletion12, _didIteratorError12, _iteratorError12, _iterator12, _step12, id2, _onResolveCallbacks$i, result, keys, pluginName, path3, namespace, suffix, external, sideEffects, pluginData, errors, warnings, watchFiles, watchDirs;
              ...
              while (1) {
                switch (_context5.prev = _context5.next) {
                  case 0:
                    ...
                    _context5.prev = 4;
                    _iterator12 = request.ids[Symbol.iterator]();
          ...
          requestCallbacks["on-load"] = function _callee4(id, request) {
            var response, name, callback, note, _iteratorNormalCompletion13, _didIteratorError13, _iteratorError13, _iterator13, _step13, id2, _onLoadCallbacks$id, result, keys, pluginName, contents, resolveDir, pluginData, loader, errors, warnings, watchFiles, watchDirs;
              ...
              while (1) {
                switch (_context6.prev = _context6.next) {
                  case 0:
                    ...
                    _context6.prev = 4;
                    _iterator13 = request.ids[Symbol.iterator]();
          ...
          if (onEndCallbacks.length > 0) {
            runOnEndCallbacks = function runOnEndCallbacks(result, done) {
              (function _callee5() {
                var onEndErrors, onEndWarnings, _iteratorNormalCompletion14, _didIteratorError14, _iteratorError14, _iterator14, _step14, _step14$value, name, callback, note, newErrors, newWarnings, value, keys, errors, warnings, _result$errors, _result$warnings;
                  ...
                  while (1) {
                    switch (_context7.prev = _context7.next) {
                      case 0:
                        ...
                        _context7.prev = 5;
                        _iterator14 = onEndCallbacks[Symbol.iterator]();
                      ...
                      case 7:
                        ...
                        _step14$value = _step14.value, name = _step14$value.name, callback = _step14$value.callback, note = _step14$value.note;
                        newErrors = void 0;
                        newWarnings = void 0;
                        _context7.prev = 11;
                        _context7.next = 14;
          ...
          scheduleOnDisposeCallbacks = function scheduleOnDisposeCallbacks() {
            ...
            try {
              var _loop2 = function _loop2() {
                var cb = _step15.value;
                setTimeout(function () {
                  return cb();
                }, 0);
              };

              for (var _iterator15 = onDisposeCallbacks[Symbol.iterator](), _step15; !(_iteratorNormalCompletion15 = (_step15 = _iterator15.next()).done); _iteratorNormalCompletion15 = true) {
                _loop2();
              }
            } catch (err) {
...
function sanitizeStringArray(values, property) {
  ...
  try {
    for (var _iterator19 = values[Symbol.iterator](), _step19; !(_iteratorNormalCompletion19 = (_step19 = _iterator19.next()).done); _iteratorNormalCompletion19 = true) {
...
function generateBinPath() {
  ...
  if (/\.zip\//.test(binPath)) {
    ...
    if (pnpapi) {
      ...
      var binTargetPath = path.join(root, "node_modules", ".cache", "esbuild", "pnpapi-".concat(pkg.replace("/", "-"), "-", "0.19.8", "-").concat(path.basename(subpath)));
...
var ensureServiceIsRunning = function ensureServiceIsRunning() {
  ...
  var child = child_process.spawn(command, args.concat("--service=".concat("0.19.8"), "--ping"), {
    windowsHide: true,
...
var runServiceSync = function runServiceSync(callback) {
  ...
  callback(service);
  var stdout = child_process.execFileSync(command, args.concat("--service=".concat("0.19.8")), {
    cwd: defaultWD,
    windowsHide: true,
    input: stdin,
